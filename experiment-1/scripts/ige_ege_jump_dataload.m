...
baseDir= '/Users/hyosubkim/Documents/GitHub/Projects/ige-ege/experiment-1/scripts';
dataDir='/Users/hyosubkim/Library/CloudStorage/OneDrive-UBC/projects/ige-ege/experiment-1/';
analyzeDir='/Users/hyosubkim/Documents/GitHub/Projects/ige-ege/experiment-1/results';

cd(dataDir);


subj = {'s01_ige_ege_jump', 's02_ige_ege_jump', 's03_ige_ege_jump', 's04_ige_ege_jump',...
    's05_ige_ege_jump', 's06_ige_ege_jump', 's07_ige_ege_jump', 's08_ige_ege_jump',...
    's09_ige_ege_jump', 's10_ige_ege_jump', 's11_ige_ege_jump', 's12_ige_ege_jump',...
    's13_ige_ege_jump', 's14_ige_ege_jump', 's15_ige_ege_jump', 's16_ige_ege_jump'};
...
save('ige_ege_jump_table.mat','T');
save('ige_ege_jump_movefile_table.mat','M');
writetable(T, 'ige_ege_jump.csv', 'Delimiter', ',')
